"""Deleted mix rate from SprayProgramChemicals
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('spray_program_chemicals', sa.Column('mix_rate_per_100L', sa.NUMERIC(precision=5, scale=2), autoincrement=False, nullable=False))
