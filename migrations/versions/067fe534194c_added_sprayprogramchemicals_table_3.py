...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["spray_record_id"], ["spray_records.id"], ondelete="CASCADE"
        ),
    ...
    op.drop_table("users")
    op.drop_constraint(
        op.f("fk_spray_program_chemicals_spray_record_id"),
...
def downgrade() -> None:
    ...
    op.add_column(
        "spray_program_chemicals",
        sa.Column("spray_record_id", sa.INTEGER(), autoincrement=False, nullable=True),
    )
